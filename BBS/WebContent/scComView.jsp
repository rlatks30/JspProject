...
<body>
	...
	<%
		...
		int point = scheduleDAO.getMyPoint(userID);
	%>
	<h2 style=text-align:center;>오늘의 스케줄 달성한 목표 </h2> <br>
	<h3 style=text-align:center;>My Point : ★<%= point %>★</h3>
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<%
								ArrayList<Schedule> list = scheduleDAO.getComList(pageNumber, userID);
