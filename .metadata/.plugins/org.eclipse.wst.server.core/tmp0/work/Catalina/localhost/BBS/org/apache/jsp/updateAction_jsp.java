 ...
 * Generated at: 2020-04-27 15:13:08 UTC
		...
		script.println("</script>");
		  ...
		  if (request.getParameter("bbsTitle") == null || request.getParameter("bbsContent") == null 
			...
			script.println("</script>");
				  ...
				  int result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsContent"));//--실제로 입력된 값을 join함수에 넣어서 실행한다.
					if (result== -1){ // 글수정 실패
						PrintWriter script = response.getWriter(); 
						script.println("<script>");
